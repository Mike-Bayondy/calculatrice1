...
public class CalculatriceUI extends JFrame implements ActionListener {
    ...
    private Calculatrice calc; // Utilisation de la logique séparée

    public CalculatriceUI() {
        super("EDOUARD CALCUL");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ("0123456789.".contains(cmd)) {
            ...
            try {
                switch (operateur) {
                    case "+": resultat = calc.addition(premierNombre, deuxiemeNombre); break;
                    case "-": resultat = calc.soustraction(premierNombre, deuxiemeNombre); break;
                    case "*": resultat = calc.multiplication(premierNombre, deuxiemeNombre); break;
                    case "/": resultat = calc.division(premierNombre, deuxiemeNombre); break;
                }
